CREATE SCHEMA IF NOT EXISTS polish_lexicon;
--;;
...
CREATE TABLE polish_lexicon.import_manifests (
  import_manifest_id bigserial PRIMARY KEY,
  manifest_sha256 text NOT NULL UNIQUE CHECK (btrim(manifest_sha256) <> ''),
...
--;;
CREATE INDEX import_manifests_imported_at_idx ON polish_lexicon.import_manifests(imported_at);
